...
storie = """You would never guess what can happen when you jump into a seemingly shallow puddle at night time!
...
# storie = """this is a test"""

list_storie = storie.split(" ") 
new_storie= []

for word in list_storie: 
    ...
    new_word = rest + first_letter + "ay"
    new_storie.append(new_word)
final_storie =  " ".join(new_storie)
print(final_storie)
