...
# Collect the names of my kitten and save them !
# Make a list of friends i went to send AD!
# Define the ad for adoption
# Checking if the name is cute
# Send AD to list of my friends
